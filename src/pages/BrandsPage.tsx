...
const brands = [
  "SOHO LADY", "SOHO GIRLS", "SOHO KIDS", "SOHO SPORTS", "SOHO MATERNITY",
  "SOHO BLUE", "LOVE SOHO", "EMMA & ELSA", "LARK & GREY", "COCO & SHAY",
  "CLASSIC CONCEPTS", "FIGUR ACTIV", "LUNA PEAK", "SWEET STORIES", "BLVD SUPPLY",
];
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
        {brands.map((brand, i) => (
          <Reveal key={brand} delay={i * 80}>
            <div className="flex items-center justify-center py-8 border border-border hover:border-foreground/30 transition-all duration-300 hover:shadow-md">
              <span className="font-display text-lg md:text-xl tracking-[0.15em] text-foreground/60">{brand}</span>
            </div>
          </Reveal>
        ))}
      </div>
