        ...
        <div className="mt-12 max-w-lg mx-auto">
          ...
          <form className="space-y-4 text-left" onSubmit={(e) => e.preventDefault()}>
            <div>
              ...
              <input
                type="text"
                className="w-full border border-border bg-background px-4 py-3 font-body text-sm text-foreground focus:outline-none focus:border-foreground/40 transition-colors"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                rows={5}
                className="w-full border border-border bg-background px-4 py-3 font-body text-sm text-foreground focus:outline-none focus:border-foreground/40 transition-colors resize-none"
              />
            </div>
            <button
              type="submit"
              className="w-full bg-primary text-primary-foreground py-3 text-xs tracking-[0.25em] uppercase font-body font-medium hover:opacity-90 transition-opacity"
            >
              Submit
            </button>
          </form>
